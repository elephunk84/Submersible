...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Sun Aug 21 19:45:02 2016
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1 = wx.StaticText(self.mainPane, wx.ID_ANY, _("Motor Power"), style=wx.ST_NO_AUTORESIZE)
        self.slider_3 = wx.Slider(self.mainPane, wx.ID_ANY, 0, 0, 10)
        self.label_2 = wx.StaticText(self.mainPane, wx.ID_ANY, _("LED Power"), style=wx.ALIGN_CENTRE | wx.ST_NO_AUTORESIZE)
        self.slider_4 = wx.Slider(self.mainPane, wx.ID_ANY, 0, 0, 10)
        self.label_3 = wx.StaticText(self.mainPane, wx.ID_ANY, _("Cam LED Power"), style=wx.ALIGN_CENTRE | wx.ST_NO_AUTORESIZE)
