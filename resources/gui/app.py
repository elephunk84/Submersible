...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Sun Aug 21 19:31:51 2016
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.sysMenu_sub = wx.Menu()
        self.sysMenu_sub.AppendSeparator()
        self.sysMenu.AppendMenu(wx.ID_ANY, _("item"), self.sysMenu_sub, "")
        ...
        self.label_1 = wx.StaticText(self.mainPane, wx.ID_ANY, _("PWM Motor Power"), style=wx.ST_NO_AUTORESIZE)
        self.slider_3 = wx.Slider(self.mainPane, wx.ID_ANY, 0, 0, 10)
        self.label_2 = wx.StaticText(self.mainPane, wx.ID_ANY, _("PWM Camera LED Power"), style=wx.ALIGN_CENTRE | wx.ST_NO_AUTORESIZE)
        self.slider_4 = wx.Slider(self.mainPane, wx.ID_ANY, 0, 0, 10)
        self.label_3 = wx.StaticText(self.mainPane, wx.ID_ANY, _("PWM Lights Power"), style=wx.ST_NO_AUTORESIZE)
    ...
    def __do_layout(self):
        ...
        sizer_7.Add(self.label_3, 0, wx.EXPAND | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
